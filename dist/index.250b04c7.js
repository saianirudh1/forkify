...
const controlRecipe = async function () {
  ...
  _viewsResultViewJsDefault.default.update(_modelJs.getPageResults());
};
const controlSearch = async function () {
  ...
  try {
    ...
    _viewsSearchViewJsDefault.default.renderError();
  }
  _viewsResultViewJsDefault.default.render(_modelJs.getPageResults());
  _viewsPaginationViewJsDefault.default.render(_modelJs.state.search);
};
const controlPage = function (page) {
  _viewsResultViewJsDefault.default.render(_modelJs.getPageResults(page));
  _viewsPaginationViewJsDefault.default.render(_modelJs.state.search);
};
...
const contolBookmarkReload = function () {
  ...
  if (storage) _modelJs.state.bookmarks = storage;
  _viewsBookmarksViewJsDefault.default.render(_modelJs.state.bookmarks);
};
const controlAddRecipe = async function (data) {
  try {
    ...
    setTimeout(function () {
      _viewsAddRecipeViewJsDefault.default._toggleHidden();
...
const init = function () {
  _viewsRecipeViewJsDefault.default.renderSuccess();
  _viewsRecipeViewJsDefault.default.addHandlerRender(controlRecipe);
  _viewsRecipeViewJsDefault.default.addHandlerServings(controlServings);
  _viewsRecipeViewJsDefault.default.addHandlerBookmark(controlBookmarks);
  _viewsSearchViewJsDefault.default.addHandlerSearch(controlSearch);
  _viewsPaginationViewJsDefault.default.addHandlerClick(controlPage);
  _viewsBookmarksViewJsDefault.default.addHandlerBookmark(contolBookmarkReload);
  _viewsAddRecipeViewJsDefault.default._addHandlerUpload(controlAddRecipe);
};
init();

},{"core-js/stable":"1PFvP","regenerator-runtime/runtime":"62Qib","./model.js":"1hp6y","./views/recipeView.js":"9e6b9","./views/searchView.js":"3rYQ6","./views/resultView.js":"2blfJ","./views/paginationView.js":"5u5Fw","./views/bookmarksView.js":"2EbNZ","./views/addRecipeView.js":"4ieaQ","./config.js":"6pr2F","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"1PFvP":[function(require,module,exports) {
...
_parcelHelpers.export(exports, "getRecipe", function () {
  return getRecipe;
});
_parcelHelpers.export(exports, "getSearchResults", function () {
  return getSearchResults;
});
_parcelHelpers.export(exports, "getPageResults", function () {
...
const getRecipe = async function (id) {
  try {
    const data = await _helperJs.AJAX(`${_configJs.API_ENDPOINT}${id}?key=${_configJs.KEY}`);
...
const getSearchResults = async function (query) {
  try {
    const data = await _helperJs.AJAX(`${_configJs.API_ENDPOINT}?search=${query}&key=${_configJs.KEY}`);
...
const getPageResults = function (page = state.search.page) {
...
const uploadRecipe = async function (newRecipe) {
  try {
    ...
    const data = await _helperJs.AJAX(`${_configJs.API_ENDPOINT}?key=${_configJs.KEY}`, recipe);
...
},{"./config.js":"6pr2F","./helper.js":"dSCNX","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"6pr2F":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "API_ENDPOINT", function () {
  return API_ENDPOINT;
});
_parcelHelpers.export(exports, "TIMEOUT", function () {
  return TIMEOUT;
});
_parcelHelpers.export(exports, "RESULT_ERROR", function () {
  return RESULT_ERROR;
});
_parcelHelpers.export(exports, "RECIPE_ERROR", function () {
  return RECIPE_ERROR;
});
_parcelHelpers.export(exports, "BOOKMARK_ERROR", function () {
  return BOOKMARK_ERROR;
});
_parcelHelpers.export(exports, "FORMAT_ERROR", function () {
  return FORMAT_ERROR;
});
_parcelHelpers.export(exports, "RESULTS_PER_PAGE", function () {
  return RESULTS_PER_PAGE;
});
_parcelHelpers.export(exports, "PREV_PAGE", function () {
  return PREV_PAGE;
});
_parcelHelpers.export(exports, "NEXT_PAGE", function () {
  return NEXT_PAGE;
});
_parcelHelpers.export(exports, "ESCAPE_KEY", function () {
  return ESCAPE_KEY;
});
...
const TIMEOUT = 10;
const RESULT_ERROR = 'Could not find any recipe for your search. Try again!';
const RECIPE_ERROR = 'Could not find this recipe. Try again!';
const BOOKMARK_ERROR = 'No bookmarks yet, Bookmark your favorite recipes!';
const FORMAT_ERROR = 'Wrong ingredient fromat! Please use the correct format :)';
const RESULTS_PER_PAGE = 10;
const PREV_PAGE = 'prev';
const NEXT_PAGE = 'next';
const ESCAPE_KEY = 'Escape';
const KEY = 'b71e2167-92de-4f4a-ad27-f0c0949abe08';
...
const getJSON = async function (url) {
  try {
    const res = await Promise.race([fetch(url), timeout(_configJs.TIMEOUT)]);
...
const AJAX = async function (url, uploadData = undefined) {
  try {
    ...
    const res = await Promise.race([fetchPro, timeout(_configJs.TIMEOUT)]);
    const data = await res.json();
...
const round = function (value, step = 1.0) {
  const inv = 1.0 / step;
...
var _fractionsDefault = _parcelHelpers.interopDefault(_fractions);
...
class RecipeView extends _viewJsDefault.default {
  ...
  _errorMessage = _configJs.RESULT_ERROR;
  ...
  addHandlerServings(handler) {
    this._parentElement.addEventListener('click', function (e) {
      const targetClick = e.target.closest('.btn--update-servings');
      if (!targetClick) return;
      const servings = +targetClick.dataset.servings;
      handler(servings);
    });
  }
  ...
  _generateMarkup() {
    ...
    <figure class="recipe__fig">
        ...
        <div class="recipe__ingredients">
          ...
          ${this._data.ingredients.map(this._generateIngridientMarkup.bind(this)).join('')}
          </ul>
        </div>
  ...
  _generateIngridientMarkup(ing) {
    return `<li class="recipe__ingredient">
          ...
          <div class="recipe__quantity">${this._getQuantity(ing.quantity)}</div>
  ...
  _getQuantity(quantity) {
    if (!quantity) return '';
    return new _fractionsDefault.default(_helperJs.round(quantity, 0.25)).toString();
  }
}
exports.default = new RecipeView();

},{"url:../../img/icons.svg":"3t5dV","fractions":"29lMd","./view.js":"2fT4v","../config.js":"6pr2F","../helper.js":"dSCNX","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"3t5dV":[function(require,module,exports) {
...
},{}],"29lMd":[function(require,module,exports) {
...
class View {
  ...
  update(data) {
    ...
    newElements.forEach((newEl, i) => {
      ...
      if (!newEl.isEqualNode(currEl) && !newEl && newEl.firstChild.nodeValue.trim() !== '') {
...
},{"regenerator-runtime":"62Qib","url:../../img/icons.svg":"3t5dV","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"3rYQ6":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
class SearchView {
...
},{"./view.js":"2fT4v","../config.js":"6pr2F","url:../../img/icons.svg":"3t5dV","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"5u5Fw":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
var _viewJs = require('./view.js');
var _viewJsDefault = _parcelHelpers.interopDefault(_viewJs);
...
class PaginationView extends _viewJsDefault.default {
  ...
  _generateMarkup() {
    ...
    if (currPage === 1 && numPages > 1) {
      return this._generateButtonMarkup(_configJs.NEXT_PAGE, currPage);
    }
    if (currPage === numPages && numPages > 1) {
      return this._generateButtonMarkup(_configJs.PREV_PAGE, currPage);
    }
    if (currPage < numPages) {
      return this._generateButtonMarkup(_configJs.PREV_PAGE, currPage).concat(this._generateButtonMarkup(_configJs.NEXT_PAGE, currPage));
    }
    return '';
  }
  _generateButtonMarkup(name, page) {
    if (name === _configJs.PREV_PAGE) {
      return `
...
},{"./view.js":"2fT4v","../config.js":"6pr2F","url:../../img/icons.svg":"3t5dV","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"2EbNZ":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
var _viewJs = require('./view.js');
var _viewJsDefault = _parcelHelpers.interopDefault(_viewJs);
...
class BookmarksView extends _viewJsDefault.default {
  ...
  _errorMessage = _configJs.BOOKMARK_ERROR;
  _message = '';
  addHandlerBookmark(handler) {
...
},{"./view.js":"2fT4v","./previewView.js":"3QsRt","../config.js":"6pr2F","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"3QsRt":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
var _viewJs = require('./view.js');
var _viewJsDefault = _parcelHelpers.interopDefault(_viewJs);
...
},{"./view.js":"2fT4v","url:../../img/icons.svg":"3t5dV","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"4ieaQ":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
require('../config.js');
var _viewJs = require('./view.js');
...
},{"../config.js":"6pr2F","./view.js":"2fT4v","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}]},["7BONy","3miIZ"], "3miIZ", "parcelRequirefade")
